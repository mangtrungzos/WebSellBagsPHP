                ...
                <div class="checkout-itemAndTotal">
                    ...
                    <div class="total-product">
                        ...
                        <div class="button--checkout">
                            <img src="../image/icon/padlock.png" alt="" class="unlock--checkout">
                        ...
                        <div class="paymentcards--wallet">
                            <div class="paymentcards--icon">
                                <img src="../image/icon/paymentcard/paypal.png" alt="" width="40px" height="40px">
                                <img class="card--icon" src="../image/icon/paymentcard/visa.png" alt="" width="40px" height="40px">
                            </div>
                        </div>
                    </div>
                </div>
