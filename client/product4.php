                    ...
                    <div class="slide-show">
                        <div class="list-images">
                            <div class="img-detail">
                                <img class="imgdetails imgdetailss" src="../image/ProductDetail/FERRAGAMO/1.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/FERRAGAMO/2.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/FERRAGAMO/3.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/FERRAGAMO/4.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/FERRAGAMO/5.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/FERRAGAMO/6.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/FERRAGAMO/6.png" alt="" >
                            </div>
                    ...
                    <div class="productDetail__selectInfo">
                        <div class="productDetail__basicInfo">
                            ...
                            <div class="productInfomation">
                                <a href="#">
                                    <h1 class="productInfomation--brand">FERRAGAMO</h1>
                                </a>
                                <p class="productInfomation__name">Hug medium leather shoulder bag</p>
                            </div>
                            <div class="priceProduct">$3,400</div>
                        </div>
                            ...
                            <div class="button__wrapper">
                                ...
                                <div class="productDetail__editor">
                                    ...
                                    <div class="according__section according__sectionContent">
                                        <p>It's easy to see why Ferragamo's bag is named 'Hug'. Made from supple leather, this medium-sized style has gold-tone 'Gancini' buckles and studs at the base to protect it from getting easily scratched.</p>
                                    </div>
