                    ...
                    <div class="slide-show">
                        <div class="list-images">
                            <div class="img-detail">
                                <img class="imgdetails imgdetailss" src="../image/ProductDetail/savette/1.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/savette/2.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/savette/3.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/savette/4.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/savette/5.png" alt="" >
                            </div>
                            <div class="img-detail">
                                <img class="imgdetails" src="../image/ProductDetail/savette/5.png" alt="" >
                            </div>
                    ...
                    <div class="productDetail__selectInfo">
                        <div class="productDetail__basicInfo">
                            ...
                            <div class="productInfomation">
                                <a href="#">
                                    <h1 class="productInfomation--brand">SAVETTE</h1>
                                </a>
                                <p class="productInfomation__name">Symmetry Pochette suede tote</p>
                            </div>
                            ...
                            <div class="button__wrapper">
                                ...
                                <div class="productDetail__editor">
                                    ...
                                    <div class="according__section according__sectionContent">
                                        <p>Savette's debut 'Symmetry' collection celebrates "geometry in its purest forms: parallel and perpendicular lines". Part of the sleek range, this 'Pochette' tote has been handmade in Italy from smooth suede and minimally detailed with gleaming gold-tone hardware. The interior is perfectly sized to fit your phone, keys and wallet.</p>
                                    </div>
